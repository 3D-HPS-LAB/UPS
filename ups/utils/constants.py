...
GRPH_COL_MAP = {'background': [0, 0, 0], 'hat': [128, 0, 0], 'hair': [255, 0, 0], 'glove': [0, 85, 0],
                ...
                'leftLeg': [85, 255, 170], 'rightLeg': [170, 255, 85], 'leftShoe': [255, 255, 0],
                'rightShoe': [255, 170, 0]}
...
NEW_GRPH_COL_MAP = {'background': [0, 0, 0], 'hair': [255, 0, 0], 'face': [0, 0, 255], 'upperclothes': [255, 85, 0],
                    'pants': [0, 85, 85], 'leftArm': [51, 170, 221], 'rightArm': [0, 255, 255],
                    'leftLeg': [85, 255, 170],
...
JOINT_NAMES = [
    ...
    'OP Nose', 'OP Neck', 'OP RShoulder', 'OP RElbow', 'OP RWrist', 'OP LShoulder', 'OP LElbow', 'OP LWrist',
    'OP MidHip', 'OP RHip', 'OP RKnee', 'OP RAnkle', 'OP LHip', 'OP LKnee', 'OP LAnkle',
    'OP REye', 'OP LEye', 'OP REar', 'OP LEar', 'OP LBigToe', 'OP LSmallToe',
    ...
    'Neck (LSP)', 'Top of Head (LSP)', 'Pelvis (MPII)', 'Thorax (MPII)',
    'Spine (H36M)', 'Jaw (H36M)', 'Head (H36M)',
...
# SMPL part segmentation labels
SMPL_SEGM_PARTS = ['rightHandIndex1', 'rightHand', 'rightForeArm', 'rightArm', 'rightShoulder',
                   'leftHandIndex1', 'leftHand', 'leftForeArm', 'leftArm', 'leftShoulder',
                   'rightToeBase', 'rightFoot', 'rightLeg', 'rightUpLeg',
                   'leftToeBase', 'leftFoot', 'leftLeg', 'leftUpLeg',
                   'head', 'neck', 'spine1', 'spine2', 'spine', 'hips']

# SMPL part segmentation index
SMPL_SEGM_PARTS_IDX = {
    0: 'rightHandIndex1', 1: 'rightHand', 2: 'rightForeArm', 3: 'rightArm', 4: 'rightShoulder',
    5: 'leftHandIndex1', 6: 'leftHand', 7: 'leftForeArm', 8: 'leftArm', 9: 'leftShoulder',
    10: 'rightToeBase', 11: 'rightFoot', 12: 'rightLeg', 13: 'rightUpLeg',
    14: 'leftToeBase', 15: 'leftFoot', 16: 'leftLeg', 17: 'leftUpLeg',
    18: 'head', 19: 'neck', 20: 'spine1', 21: 'spine2', 22: 'spine', 23: 'hips'
}

UPS_LABEL = ['background', 'skin', 'clothing']
UPS_LABEL_TO_GRPH_PARTS = {0: [0], 1: [1, 2, 3, 4, 8, 13, 14, 15, 16, 17, 18, 19], 2: [5, 6, 7, 9, 10, 11, 12]}

DATA_FOLDER = 'data'
JOINT_REGRESSOR_TRAIN_EXTRA = os.path.join(DATA_FOLDER, 'J_regressor_extra.npy')
SMPL_MODEL_DIR = os.path.join(DATA_FOLDER, 'smpl')
